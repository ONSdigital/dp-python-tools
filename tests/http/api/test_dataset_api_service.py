...
from dpytools.http.api.dataset_api_service import (
    DatasetAPIService,
...
test_urls = ["https://api.example.com/datasets", "https://api.example.com/datasets/"]
