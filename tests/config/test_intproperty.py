...
def test_int_property():
    ...
    test_property = IntegerProperty(
        _name="Test Integer property", _value=24, min_val=0, max_val=101
    )
...
def test_int_property_type_invalid():
    ...
    test_property = IntegerProperty(
        _name="Test Integer Property", _value="Not an integer", min_val=0, max_val=101
    )

    with pytest.raises(Exception) as e:
        test_property.type_is_valid()

    assert "Cannot cast Test Integer Property value Not an integer to integer." in str(
        e.value
    )
...
def test_int_property_empty_val():
    ...
    test_property = IntegerProperty(
        _name="Test Integer Property", _value=None, min_val=0, max_val=101
    )
...
def test_int_property_min_val():
    ...
    test_property = IntegerProperty(
        _name="Test Integer Property", _value=9, min_val=10, max_val=101
    )
    ...
    assert (
        "Integer value for Test Integer Property is lower than allowed minimum."
        in str(e.value)
    )
...
def test_int_property_max_val():
    ...
    test_property = IntegerProperty(
        _name="Test Integer Property", _value=102, min_val=0, max_val=101
    )
    ...
    assert (
        "Integer value for Test Integer Property is higher than allowed maximum."
        in str(e.value)
    )
