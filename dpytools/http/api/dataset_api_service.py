...
class DatasetAPIService:
    def __init__(self, dataset_api_url: str):
        ...
        self.versions = DatasetVersionsService(self.dataset_api_url, self._logger, self._http_client, self._token_auth)
        self.datasets = DatasetsService(self.dataset_api_url, self._logger, self._http_client, self._token_auth)