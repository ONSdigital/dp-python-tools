...
## To Run Locally
Make sure you have the correct version of python installed. Check poetry.lock for the versions allowed (python-versions = ">=3.11, <3.12"). Create a virtual env  with correct python version with the command. (Note make sure your venv is called .venv as in the .gitignore)
```
